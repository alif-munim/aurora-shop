            ...
            <Col md={8}>
                <ListGroup>
                    <ListGroup.Item variant="flush">
                        ...
                        {order.isDelivered ? <Message>{`Delivered on ${order.deliveredAt}`}</Message> : <Message variant="danger">
                            Not Delivered
                            </Message>
                        }
                    </ListGroup.Item>
                    ...
                    <ListGroup.Item>
                        ...
                        {order.isPaid ? <Message>{`Paid on ${order.paidAt}`}</Message> : <Message variant="danger">
                            Not Paid
                            </Message>
                        }
                    </ListGroup.Item>
